...
const envSchema = z.object({
  ...
  ECI_CONSTITUENCY_LIST_URL: z.string().optional().default("https://results.eci.gov.in/ResultAcGenMay2026/statewiseS111.htm"),
  ECI_CANDIDATE_DETAIL_URL_TEMPLATE: z.string().optional().default("https://results.eci.gov.in/ResultAcGenMay2026/candidateswise-S11{constituencyNumber}.htm"),
